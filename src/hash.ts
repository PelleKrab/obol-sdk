...
import { type ClusterDefintion, type ClusterLock } from './types.js'
...
const newCreatorContainerType = (configOnly: boolean): ContainerType<any> => {
  return configOnly ? creatorAddressWrapperType : creatorContainerType
}

const newOperatorContainerType = (configOnly: boolean): ContainerType<any> => {
